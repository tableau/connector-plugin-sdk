...
Similar to connection-builder but is used to build the JDBC properties file. For JDBC Connection URL, it is suggested that connection-properties contain secure attributes such as username and password. 
