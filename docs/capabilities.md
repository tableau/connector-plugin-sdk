...
CAP_FORCE_COUNT_FOR_NUMBEROFRECORDS | Set to 'yes' to  use COUNT() rather than SUM() for calculating number of records.  Available in Tableau 2020.2 and newer. | &ndash; | &ndash;  
