...
def create_parser():
    ...
    parser.add_argument('--verify', dest='smoke_test', action='store_true', help='Verifies the connection to a data source against test in your .ini file with SmokeTest = True.', required=False)  # noqa: E501
    return parser
