        ...
        # Add smoke tests
            ...
            try:
                ...
                test_config.add_expression_test('StaplesConnectionTest', STAPLES_TDS, sect.get(KEY_EXCLUSIONS, ''),
                                                test_path + 'connection_tests/staples/setup.staples_connection.txt', test_dir,
                ...
                test_config.add_expression_test('CastCalcsConnectionTest', CALCS_TDS, sect.get(KEY_EXCLUSIONS, ''),
                                                test_path + 'connection_tests/calcs/setup.calcs_connection.txt', test_dir, get_password_file(sect),
