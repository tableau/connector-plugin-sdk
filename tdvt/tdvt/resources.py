...
def get_test_file_paths(root_directory, test_name, output_dir):
    """Given a test name like 'exprtests/setup.calcs_data.txt', return full paths to the setup file its self,
    any actual file, and a list of any existing expected files (can be numbered)."""
...
def find_file_path(root_directory, base_file, default_dir):
    """Return the full path to base_file using either the root_directory and base_file, or a default directory and
    base_file from there."""
